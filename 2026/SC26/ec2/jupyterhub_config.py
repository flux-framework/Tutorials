...
# IMPORTANT: if you use nginx (recommended) with letsencrypt you do not need this.
...
c.EC2Spawner.ami = "ami-04fde965376f2d904"
...
c.EC2Spawner.security_group_ids = ["sg-0ddfbe3cd0f9253d3"]

# The VPC subnet to launch the instances in. Must have internet access.
c.EC2Spawner.subnet_id = "subnet-0b0e2408f9960d3f6"
